<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="检验项目id" prop="inspectionItemId">
        <el-input
    ...
    <el-table v-loading="loading" :data="orderItemList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="检验项目id" align="center" prop="inspectionItemId" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="检验项目id" prop="inspectionItemId">
          <el-input v-model="form.inspectionItemId" placeholder="请输入检验项目id" />
        </el-form-item>
        <el-form-item label="金额" prop="amount">
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$confirm('是否确认删除订单条目编号为"' + ids + '"的数据项?', "警告", {
    ...
    handleExport() {
      ...
      this.$confirm('是否确认导出所有订单条目数据项?', "警告", {
          confirmButtonText: "确定",
          cancelButtonText: "取消",
          type: "warning"
        }).then(function() {
